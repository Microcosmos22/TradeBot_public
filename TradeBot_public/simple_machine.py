...
def load_train_val(ncandles=32000, candle=Client.KLINE_INTERVAL_1HOUR):
    ...
    target_train, features_train, _, _ = get_historical_data_trim([end_of_training, ncandles], 13, candle_length = candle, normalize=False, plot=False)
    ...
    target_val, features_val, _, _ = get_historical_data_trim([end_of_val, int(ncandles/4)], 13, candle_length = candle, normalize=False, plot=False)
...
if __name__ == "__main__":
    ...
    for candle in candl:
        ...
        while ((indices == 0) or (indices+1)*onlyfirstpoints < target_train.shape[0]):
            ...
            optimizer = Adam(learning_rate=float(learn_rate))  # You can change 0.001 to your desired learning rate
            ...
            import os, time
            file1 = r"..\traincurves\trainerror_" + modelpath[12:] + ".png"
            file2 = r"..\traincurves\mae_" + modelpath[12:] + ".png"
            file3 = r"..\traincurves\valerror_" + modelpath[12:] + ".png"
